...
export const en = {
  ...
  systemPill: {
    ...
    pill: {
      thinking: "Thinking...",
      loadingModel: "Loading {model}... (first use can take a minute)",
      waitingForChat: "Waiting for the current generation to finish...",
      replace: "Replace",
      copy: "Copy",
      copied: "Copied",
      ...
      undo: "Undo",
      replaced: "Replaced",
      truncatedNotice: "Selection was truncated",
      noSelection: "No text selected",
      secureInput: "Unavailable in secure fields",
      captureFailed: "Couldn't read the selection here",
      backendDown: "Unsloth isn't running",
      startBackend: "Start it",
      signedOut: "Sign in to Unsloth Studio first",
      modelMissing: "No model configured for this action",
      loadFailed: "Couldn't load {model}",
      applyFailed: "Couldn't replace the text — result copied instead",
      stalled: "The model didn't respond",
      noActions: "No actions enabled",
      openStudio: "Open Unsloth Studio to configure actions",
    },
    actions: {
      rewrite: "Rewrite",
      rewritePrompt:
        "Rewrite the following text to improve clarity and flow while keeping its meaning and tone. Reply with only the rewritten text.\n\n{selection}",
      proofread: "Proofread",
      proofreadPrompt:
        "Fix spelling, grammar, and punctuation in the following text. Keep the wording and style otherwise unchanged. Reply with only the corrected text.\n\n{selection}",
      answer: "Answer",
      answerPrompt:
        "Answer the following question or request concisely.\n\n{selection}",
      summarize: "Summarize",
      summarizePrompt:
        "Summarize the following text in a few clear sentences: {selection}",
      ask: "Ask...",
    },
    settings: {
      tab: "Assistant",
      ...
      enable: "Enable selection pill",
      enableDescription: "Press {hotkey} on selected text in any app.",
      setUp: "Set up...",
      ...
      defaultModelDescription:
        "Answers pill actions and the ask bar. Leave unset to use whichever model is already loaded.",
