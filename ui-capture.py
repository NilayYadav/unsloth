...
async def main():
    ...
    for label, port in [('BEFORE', 18753), ('AFTER', 18754)]:
        ...
        result, facts[label] = await drive(session, output, label)
    ...
    hstack_images(shots['BEFORE'], shots['AFTER'], output / 'pr10753-before-after.png',
                  label_left='BEFORE d0dbe9059 — 1 failed request',
                  label_right='AFTER 1f9e49059 — rejected before recording')
